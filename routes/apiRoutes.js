...
module.exports = function (app) {
  ...
  app.get("/api/stocks/sorted/gainers", function(req, res) {
    db.Quote.findAll({
      where: {
        percentChange: {
          $gte: "0.001"
  ...
  app.get("/api/stocks/sorted/losers", function(req, res) {
    db.Quote.findAll({
      where: {
        percentChange: {
          $lte: 0.000
...
//           createQuotes(repos.results.reverse());
//           rp({
//             url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=PYPL%2CGE%2CCOST%2CUTX%2CTMO%2CNKE%2CAVGO%2CGILD%2CTXN%2CQCOM%2CBKNG%2CBMY%2CNEE%2CCOP%2CSBUX%2CUSB%2CLOW%2CLMT%2CGS%2CSLB%2CUPS%2CAXP%2CCVS%2CANTM%2CCAT&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//             json: true
//           })
//             .then(function (repos) {
//               console.log(repos.results.length);
//               createQuotes(repos.results.reverse());
//               rp({
//                 url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=TJX%2CAMT%2CWBA%2CAET%2CEOG%2CBDX%2CCME%2CBIIB%2CDHR%2CADP%2CMDLZ%2CDUK%2CMS%2CCB%2CAGN%2CSPG%2CPNC%2CISRG%2CCSX%2CESRX%2CCHTR%2CATVI%2CINTU%2CSCHW%2CCL&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                 json: true
//               })
//                 .then(function (repos) {
//                   console.log(repos.results.length);
//                   createQuotes(repos.results.reverse());
//                   rp({
//                     url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=OXY%2CFDX%2CCELG%2CRTN%2CCI%2CSYK%2CBSX%2CBLK%2CGD%2CFOXA%2CPX%2CD%2CNOC%2CMPC%2CNSC%2CSO%2CHUM%2CTGT%2CVRTX%2CILMN%2CSPGI%2CZTS%2CDE%2CGM%2CCCI&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                     json: true
//                   })
//                     .then(function (repos) {
//                       console.log(repos.results.length);
...
//                           createQuotes(repos.results.reverse());
//                           rp({
//                             url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=HCA%2CKHC%2CWM%2CDAL%2CFIS%2CSYY%2CBAX%2CTRV%2CAPD%2CMAR%2CALL%2CAFL%2CAMAT%2CFISV%2CETN%2CKMI%2CHAL%2CSRE%2CEQIX%2CSHW%2CAPC%2CPSA%2CWMB%2CEW%2CEA&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                             json: true
//                           })
//                             .then(function (repos) {
//                               console.log(repos.results.length);
//                               createQuotes(repos.results.reverse());
//                               rp({
//                                 url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=ROP%2CADI%2CJCI%2CDG%2CLYB%2CEL%2CSTI%2CYUM%2CPEG%2CADSK%2CCXO%2CORLY%2CADM%2CTEL%2CCNC%2COKE%2CVFC%2CREGN%2CAPH%2CALXN%2CGIS%2CLUV%2CEBAY%2CPXD%2CSTT&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                                 json: true
//                               })
//                                 .then(function (repos) {
//                                   console.log(repos.results.length);
//                                   createQuotes(repos.results.reverse());
//                                   rp({
//                                     url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=COL%2CPPL%2CDXC%2CRHT%2CHLT%2CDTE%2CPAYX%2CMNST%2CROK%2CVTR%2CWY%2CA%2CXLNX%2CES%2CNTRS%2CAZO%2CDLTR%2CAPTV%2CUAL%2CPCAR%2CCMI%2CIQV%2CMSI%2CPH%2CSYF&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                                     json: true
//                                   })
//                                     .then(function (repos) {
//                                       console.log(repos.results.length);
...
//                                           createQuotes(repos.results.reverse());
//                                           rp({
//                                             url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=HRS%2CCLX%2CVRSK%2CNTAP%2CIP%2CWLTW%2CCBS%2CCTL%2CCERN%2CINFO%2CKEY%2CTSN%2CRF%2CFE%2CGPN%2CNUE%2CBXP%2CIDXX%2CAMP%2CK%2CRCL%2CO%2CSBAC%2CFITB%2CCFG&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                                             json: true
//                                           })
//                                             .then(function (repos) {
//                                               console.log(repos.results.length);
//                                               createQuotes(repos.results.reverse());
//                                               rp({
//                                                 url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=SWK%2CALGN%2CFLT%2CBBY%2CFCX%2CCAG%2CMKC%2CDV%2CDVN%2CESS%2CHIG%2COMC%2CMYL%2CLLL%2CNEM%2CMRO%2CULTA%2CLH%2CAWK%2CAEE%2CCAH%2CTDG%2CAME%2CTSS%2CRSG%2CEVRG&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                                                 json: true
//                                               })
//                                                 .then(function (repos) {
//                                                   console.log(repos.results.length);
//                                                   createQuotes(repos.results.reverse());
//                                                   rp({
//                                                     url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=AMD%2CBLL%2CVRSN%2CHBAN%2CABMD%2CETR%2CSWKS%2CRMD%2CCTAS%2CEXPE%2CHES%2CMCHP%2CWCG%2CWAT%2CGPC%2CAPA%2CHSY%2CCHD%2CFAST%2CABC%2CIFF%2CMTD%2CCMS%2CTTWO%2CCMA&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                                                     json: true
//                                                   })
//                                                     .then(function (repos) {
//                                                       console.log(repos.results.length);
...
//                                                                   createQuotes(repos.results.reverse());
//                                                                   rp({
//                                                                     url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=VAR%2CSTX%2CUHS%2CFMC%2CHFC%2CDISCK%2CLNT%2CM%2CWYNN%2CDRE%2CJNPR%2CMLM%2CHII%2CNDAQ%2CRJF%2CAES%2CCPRT%2CADS%2CZION%2CNI%2CPNW%2CPKI%2CJBHT%2CPVH%2CURI&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                                                                     json: true
//                                                                   })
//                                                                     .then(function (repos) {
//                                                                       console.log(repos.results.length);
//                                                                       createQuotes(repos.results.reverse());
//                                                                       rp({
//                                                                         url: "https://marketdata.websol.barchart.com/getQuote.json?apikey=5f741310352d2cc283ed9fa403995c53&symbols=NCLH%2CBEN%2CFRT%2CIPG%2CPRGO%2CJEC%2CNLSN%2CMAS%2CQRVO%2CIVZ%2CEQT%2CTMK%2CARNC%2CIRM%2CPKG%2CSNA%2CLKQ%2CKORS%2CDVA%2CRE%2CSLG%2CWU%2CBWA%2CXRAY%2CBF.B&type=minutes&startDate=20100101&endDate=20130101&maxRecords=10&interval=60&order=asc&sessionFilter=EFK&splits=true&dividends=true&volume=sum&nearby=1&jerq=true&exchange=NYSE%2CAMEX%2CNASDAQ&backAdjust=false&daysToExpiration=1&contractRoll=expiration",
//                                                                         json: true
//                                                                       })
//                                                                         .then(function (repos) {
//                                                                           console.log(repos.results.length);
